@echo off
echo 🚀 Starting StudyMate Profile Service...
echo ==================================

REM Get the directory of this script
set SCRIPT_DIR=%~dp0
set BACKEND_DIR=%SCRIPT_DIR%..
set SERVICE_DIR=%BACKEND_DIR%\agents\profile-service
...
netstat -ano | findstr :8006 >nul
if not errorlevel 1 (
    echo ⚠️  Port 8006 appears to be in use. You may need to stop the existing service.
)

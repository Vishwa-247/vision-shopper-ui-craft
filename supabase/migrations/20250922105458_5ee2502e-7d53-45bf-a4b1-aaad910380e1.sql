...
-- RLS policies for interview recordings storage
CREATE POLICY IF NOT EXISTS "Users can upload their own recordings"
ON storage.objects
FOR INSERT
WITH CHECK (
...
CREATE POLICY IF NOT EXISTS "Users can view their own recordings"
ON storage.objects
FOR SELECT
USING (
  bucket_id = 'interview-recordings'
...
CREATE POLICY IF NOT EXISTS "Users can delete their own recordings"
ON storage.objects
FOR DELETE
USING (
  bucket_id = 'interview-recordings'
